function carregarSessoes() {
  ...
  const selectSessao = document.getElementById('sessao-ingresso');
...
document.getElementById('form-ingresso').addEventListener('submit', function (e) {
  ...
  const sessaoIndex = document.getElementById('sessao-ingresso').value;
...
function exibirIngressosVendidos() {
  ...
  ingressos.forEach((ingresso, index) => {
    ...
    linha.innerHTML = `
      ...
      <td>
        <button class="btn btn-sm btn-danger" onclick="excluirIngresso(${index})">Excluir</button>
      </td>
    `;
